...
public class EventManager : MonoBehaviour
{
    ...
    public delegate void EventDelegate<T>(T e) where T : GameFarmingEvent;
    private delegate void EventDelegate(GameFarmingEvent e);
    ...
    private EventDelegate AddDelegate<T>(EventDelegate<T> del) where T : GameFarmingEvent
    {
    ...
    public void AddListener<T>(EventDelegate<T> del) where T : GameFarmingEvent
    {
        AddDelegate<T>(del);
    }

    public void AddListenerOnce<T>(EventDelegate<T> del) where T : GameFarmingEvent
    {
    ...
    public void RemoveListener<T>(EventDelegate<T> del) where T : GameFarmingEvent
    {
    ...
    public bool HasListener<T>(EventDelegate<T> del) where T : GameFarmingEvent
    {
        return delegateLookup.ContainsKey(del);
    }

    public void TriggerEvent(GameFarmingEvent e)
    {
        EventDelegate del;
    ...
    public bool QueueEvent(GameFarmingEvent evt)
    {
    ...
    void Update()
    {
        ...
        while (m_eventQueue.Count > 0)
        {
            ...
            GameFarmingEvent evt = m_eventQueue.Dequeue() as GameFarmingEvent;
            TriggerEvent(evt);
